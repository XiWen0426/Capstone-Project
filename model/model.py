...
from utils_nn import LSTM, Linear
...
class EncoderRNN(nn.Module):
	def __init__(self, args, pretrained):
		...
		self.gru = nn.GRU(input_size=args.embed_size,
...
class AttnDecoderRNN(nn.Module):
    def __init__(self, args, pretrained, dropout_p=0.1, max_length=MAX_LENGTH):
        super(AttnDecoderRNN, self).__init__()
        self.hidden_size = 2*args.hidden_size
        self.output_size = args.char_vocab_size
